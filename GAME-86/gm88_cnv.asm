...
;--------------------------------
;
; GAME Interpreter for SBC-8088
; 2022.02.06 modified by A.honda
;
;--------------------------------
...
;
; function call to Universal Monitor
; ( INT 21H )
;
;------------------------------------
_c_putch: ; input al
...
_main:
	...
	mov	ax,_text_buf
;	mov	word ptr _var+58,ax
	mov	word ptr _var+122,ax		; 122 : '=' *2
;	mov	word ptr _var+20,32767
	mov	word ptr _var+84,32767		; 84 : '*' *2
	call	_newText1
	mov	ax, op_msg_
	push	ax
	call	_c_puts
...
op_msg_:	db	"GAME-86 SBCV20/8088 Edition"
newl_m:		db	"\r\n",0
rdymsg_:	db	"\r\n*READY\r\n",0
...
_stack:		ds	200-32
_var:		ds	256
_text_buf:	ds	RAM_END+1 - _text_buf

text_size	equ	RAM_END+1 - _text_buf
