...
extern char c_kbhit(void);
extern char c_getch(void);
extern void c_putch(char);
...
#define SIZE_IBUF 160 /* i-code conversion buffer size */
#define SIZE_LIST 0x7780 /* List buffer size 30720bytes */
...
#define STR_EDITION "SBCV20/8088"
...
char (*inb)(unsigned int) = (void *) 0x000e;
char (*c_getch)(void) = (void *) 0x02b8;
void (*c_putch)(char) = (void *) 0x01e8;
...
/*			if (gstki >= SIZE_GSTK - 2) { // stack overflow ? */
			...
			gstk[gstki++] = (unsigned char*)(uintptr_t)lstki; /*FOR stack index*/
